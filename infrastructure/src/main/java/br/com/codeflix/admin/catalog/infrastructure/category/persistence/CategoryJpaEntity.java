package br.com.codeflix.admin.catalog.infrastructure.category.persistence;
...
public class CategoryJpaEntity {
    ...
    @Column(name = "created_at", nullable = false, columnDefinition = "DATETIME(6)") //precision of 6, micro-second
