...
public class CategoryMySQLGatewayTest {
    ...
    @Test
    public void givenAPrePersistedAndValidCategoryId_whenTryToDeleteIt_thenShouldDeleteCategory() {
    ...
    @Test
    public void givenInValidCategoryId_whenTryToDeleteIt_thenShouldDeleteCategory() {
        Assertions.assertEquals(0, categoryRepository.count());
    ...
    @Test
    public void givenValidCategoryIdNotStored_whenCallsFindById_thenShouldReturnEmpty() {
        Assertions.assertEquals(0, categoryRepository.count());
    ...
    @Test
    public void givenPrePersistedCategoriesWithDocAsTerms_whenCallsFindAllAndTermsMatchesCategoryName_thenShouldReturnPaginated() {
        final var expectedPage = 0;
        final var expectedPerPage = 1;
    ...
    @Test
    public void givenPrePersistedCategoriesWithMaisAssistidaAsTerms_whenCallsFindAllAndTermsMatchesCategoryDescription_thenShouldReturnPaginated() {
        final var expectedPage = 0;
        final var expectedPerPage = 1;
        final var expectedTotal = 1;
        ...
        final var documentarios = Category.newCategory("Documentários", "A categoria menos assitida", true);
