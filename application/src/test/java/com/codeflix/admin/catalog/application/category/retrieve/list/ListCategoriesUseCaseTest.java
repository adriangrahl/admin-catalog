...
public class ListCategoriesUseCaseTest {
    ...
    public void givenAValidQuery_whenCallsListCategories_thenShouldReturnCategories() {
        ...
        final var aQuery =
                new CategorySearchQuery(expectedCurrentPage, expectedPerPage, expectedTerms, expectedSort, expectedDirection);

        final var expectedPagination = new Pagination<>(expectedCurrentPage, expectedPerPage, categories.size(), categories);
        ...
        Assertions.assertEquals(expectedCurrentPage, actualResult.currentPage());
